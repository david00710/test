...
def run_experiment(world, alg_name, experiment_known, experiment_learned, num_times, show_print):
    if world == 'officeworld':
        testing_params_k, learning_params_k, tester_k, curriculum_k = get_params_office_world(experiment_known)
    ...
    if alg_name == "qrm":
        ...
        # QRM
    if alg_name == "aqrm":
        run_aqrm_experiments(alg_name, tester_k, tester_l, curriculum, num_times, show_print)
...
if __name__ == "__main__":
    ...
    # Getting params
    algorithms = ["dqn", "hrl", "hrl-rm", "qrm", "aqrm"]
    ...
    if world == "office":
        experiment_l = "../experiments/office/tests/officel.txt"
        experiment_t = "../experiments/office/tests/officet.txt"
    else: 
        experiment_l = "../experiments/%s/tests/%s_%dl.txt"%(world, world, map_id)
        experiment_t = "../experiments/%s/tests/%s_%dt.txt"%(world, world, map_id)
    world += "world"

    print("world: " + world, "alg_name: " + alg_name, "experiment: " + experiment_l, "num_times: " + str(num_times), show_print)
    run_experiment(world, alg_name, experiment_t, experiment_l, num_times, show_print)
